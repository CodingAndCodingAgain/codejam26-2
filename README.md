...
Hi, a couple of things that I would like to clarify before you go in ( I assume I'm speaking to the reviewer or whoever reads the repo )

1. Big fan of Kitboga, I hope he keeps on doing what he is doing for many years.
2. I don't want any prizes, if selected ( which is a big if ), I want my prize to be either donated or passed on to the next participant
3. Doing this with vanilla JS, CSS and HTML wasn't the best experience. I would recommend for the next one to at least provide the participants with a template that includes some of the following:

- GSAP: Incredible library for effects and animations, superusefull if you want to make cool things.
- Bootstrap/Tailwind/Ant Design: Any graphic library will do, the main point is having some tools available to us and not have to code a popup and things like that.
- ThreeJS: Maybe? For 3D it is very usefull and cool.
- ( Optional ): React, VueJS or Angular, not required but extremely usefull for writting cleaner and more reusable code.

This is the first time I participate in something like this, even if I am not selected I have to say it was fun.

Thank you, Kitboga and the rest of the team and community.

Keep making the world a better place ( and a funnier one too !).

Best regards.

## Update ( I am dumb )

I didn't read the terms correctly and though I couldn't use external libraries.

I will pay more attention next time.

I didn't have much time for this codejam this year, I hope I can participate again next year.
...
window.top.postMessage(
  { type: "setVideoFilter", value: "hue-rotate(90deg) saturate(1.5)" },
  "*",
);
...
window.top.postMessage(
  { type: "setVideoFilter", value: "hue-rotate(20deg)" },
  "*",
);
```
